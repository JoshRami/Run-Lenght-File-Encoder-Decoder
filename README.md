...
- [x] Input files will only contain text when decoded.
- [x] The option flag determines whether to encode or decode the given file.
- [x] The application can override the file, or create another one. This is left optional to the developer.
